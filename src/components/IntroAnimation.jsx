...
const IntroAnimation = ({ onComplete, onPlatformSelect }) => {
...
// Wrapper component that shows intro then app
export const AppWithIntro = ({ children, components }) => {
  const [showIntro, setShowIntro] = useState(true);
  const [selectedPlatform, setSelectedPlatform] = useState(null);

  const handleIntroComplete = (platform) => {
  ...
  if (components && components[selectedPlatform]) {
    return components[selectedPlatform];
  }
